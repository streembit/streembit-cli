...
import { BlockchainCmds } from "../apps/blockchain/cmds.js";
...
describe("CMD Handlers", function () {
  ...
  describe("Blockchain Commands, validation", function () {
    ...
    it("should validate HEX values", function () {
      const validHex =
        "a9f98243d3c1bdff8ea4bbc14874e971ac6fc63ce7542efaa2baae0981029846";
  ...
  describe("Blockchain Commands", function () {
    ...
    const txid_vout_obj =
      "";
    const txid_vout_scrpubkey_obj =
      "";
    const addr_amt_r =
      "7B2261396639383234336433633162646666386561346262633134383734653937316163366663363363653735343265666161326261616530393831303239383436223A312E3233342C2237363830616465633865616263616261633637366265396538333835346164653062643232636462223A327D";
    const addr_r =
      "5B2261396639383234336433633162646666386561346262633134383734653937316163366663363363653735343265666161326261616530393831303239383436222C2237363830616465633865616263616261633637366265396538333835346164653062643232636462225D";
    ...
    it("addmultisigaddress command", function (done) {
      stdout = capcon.interceptStdout(function capture() {
        bc.doAddmultisigaddress(2, `["${validHex}"]`, "acc_mocha")
          .then((res) => {
        ...
        bc.doAddmultisigaddress("z", "[]")
          .then((res) => {
            done(
              new Error(
                "Expected non-integer to reject in doAddmultisigaddress"
              )
            );
          })
          .catch((err) => {
        ...
        bc.doAddmultisigaddress(2, `["${invHex}"]`)
          .then((res) => {
            done(
              new Error(
                "Expected non-hex key to reject in doAddmultisigaddress"
              )
            );
          })
          .catch((err) => {
    ...
    it("backupwallet command", function (done) {
      stdout = capcon.interceptStdout(function capture() {
        ...
        bc.doBackupwallet(invDestination)
          .then((res) => {
    ...
    it("createrawtransaction command", function (done) {
      stdout = capcon.interceptStdout(function capture() {
        bc.doCreaterawtransaction(txid_vout_obj, addr_amt_r)
          .then((res) => {
        ...
        bc.doCreaterawtransaction(invHex, addr_amt_r)
          .then((res) => {
        ...
        bc.doCreaterawtransaction(invHex, invBills)
          .then((res) => {
    ...
    it("decoderawtransaction command", function (done) {
      stdout = capcon.interceptStdout(function capture() {
        bc.doDecoderawtransaction(validHex)
          .then((res) => {
        ...
        bc.doDecoderawtransaction(invHex)
          .then((res) => {
    ...
    it("dumpwallet command", function (done) {
      stdout = capcon.interceptStdout(function capture() {
        ...
        bc.doDumpprivkey(invDestination)
          .then((res) => {
    ...
    it("encryptwallet command", function (done) {
      stdout = capcon.interceptStdout(function capture() {
        ...
        bc.doEncryptwallet(destination)
          .then((res) => {
    ...
    it("getaccountaddress command", function (done) {
      stdout = capcon.interceptStdout(function capture() {
        bc.doGetaccountaddress(plainTxt)
          .then((res) => {
        ...
        bc.doGetaccountaddress(destination)
          .then((res) => {
            done(new Error("Expected plain text"));
          })
          .catch((err) => {
    ...
    it("getaddressesbyaccount command", function (done) {
      stdout = capcon.interceptStdout(function capture() {
        bc.doGetaddressesbyaccount(plainTxt)
          .then((res) => {
        ...
        bc.doGetaddressesbyaccount(destination)
          .then((res) => {
            done(new Error("Expected plain text"));
          })
          .catch((err) => {
    ...
    it("getrawtransaction command", function (done) {
      stdout = capcon.interceptStdout(function capture() {
        bc.doGetrawtransaction(validHex)
          .then((res) => {
    ...
    it("getrawtransaction command", function (done) {
      stdout = capcon.interceptStdout(function capture() {
        bc.doGetreceivedbyaccount(plainTxt)
          .then((res) => {
        ...
        bc.doGetreceivedbyaccount(destination)
          .then((res) => {
            done(new Error("Expected plain text"));
          })
          .catch((err) => {
    ...
    it("getreceivedbyaddress command", function (done) {
      stdout = capcon.interceptStdout(function capture() {
        bc.doGetreceivedbyaddress(validHex)
          .then((res) => {
    ...
    it("gettxout command", function (done) {
      stdout = capcon.interceptStdout(function capture() {
        bc.doGettxout(validHex, 10, true)
          .then((res) => {
        ...
        bc.doGettxout(validHex, "falzzy", true)
          .then((res) => {
    ...
    it("importprivkey command", function (done) {
      stdout = capcon.interceptStdout(function capture() {
        bc.doImportprivkey(validHex, plainTxt, true)
          .then((res) => {
    ...
    it("listtransactions command", function (done) {
      stdout = capcon.interceptStdout(function capture() {
        bc.doListtransactions(plainTxt)
          .then((res) => {
        ...
        bc.doListtransactions(destination)
          .then((res) => {
            done(new Error("Expected plain text"));
          })
          .catch((err) => {
    ...
    it("lockunspent command", function (done) {
      stdout = capcon.interceptStdout(function capture() {
        bc.doLockunspent(txid_vout_obj)
          .then((res) => {
    ...
    it("sendfrom command", function (done) {
      stdout = capcon.interceptStdout(function capture() {
        bc.doSendfrom(plainTxt, validHex, 4, 2)
          .then((res) => {
        ...
        bc.doSendfrom(destination, validHex, 4, 2)
          .then((res) => {
        ...
        bc.doSendfrom(plainTxt, invHex, 4, 2)
          .then((res) => {
        ...
        bc.doSendfrom(plainTxt, invHex, "falzzy", 2)
          .then((res) => {
    ...
    it("sendmany command", function (done) {
      stdout = capcon.interceptStdout(function capture() {
        bc.doSendmany(plainTxt, addr_r, 5)
          .then((res) => {
        ...
        bc.doSendmany(destination, addr_r, 5)
          .then((res) => {
            done(new Error("Expected plain text as the first param"));
          })
          .catch((err) => {
        ...
        bc.doSendmany(plainTxt, invBills, 5)
          .then((res) => {
            done(new Error("Expected valid hex as the second param"));
          })
          .catch((err) => {
        ...
        bc.doSendmany(plainTxt, invBills, "falzzy")
          .then((res) => {
            done(new Error("Expected integer as the third param"));
          })
          .catch((err) => {
    ...
    it("sendrawtransaction command", function (done) {
      stdout = capcon.interceptStdout(function capture() {
        bc.doSendrawtransaction(validHex)
          .then((res) => {
        ...
        bc.doSendrawtransaction(invHex)
          .then((res) => {
            done(new Error("Expected valid hex"));
          })
          .catch((err) => {
    ...
    it("setaccount command", function (done) {
      stdout = capcon.interceptStdout(function capture() {
        bc.doSetaccount(validHex, plainTxt)
          .then((res) => {
        ...
        bc.doSetaccount(invHex, plainTxt)
          .then((res) => {
            done(new Error("Expected valid hex"));
          })
          .catch((err) => {
        ...
        bc.doSetaccount(validHex, destination)
          .then((res) => {
            done(new Error("Expected valid hex"));
          })
          .catch((err) => {
    ...
    it("signmessage command", function (done) {
      stdout = capcon.interceptStdout(function capture() {
        bc.doSignmessage(validHex, plainTxt)
          .then((res) => {
        ...
        bc.doSignmessage(invHex, plainTxt)
          .then((res) => {
            done(new Error("Expected valid hex"));
          })
          .catch((err) => {
        ...
        bc.doSignmessage(validHex, destination)
          .then((res) => {
            done(new Error("Expected valid hex"));
          })
          .catch((err) => {
    ...
    it("signrawtransaction command", function (done) {
      stdout = capcon.interceptStdout(function capture() {
        bc.doSignrawtransaction(validHex, txid_vout_scrpubkey_obj, addr_r)
          .then((res) => {
        ...
        bc.doSignrawtransaction(invHex, txid_vout_scrpubkey_obj, addr_r)
          .then((res) => {
        ...
        bc.doSignrawtransaction(validHex, invBills, addr_r)
          .then((res) => {
            done(new Error("Expected valid hex as the second param"));
          })
          .catch((err) => {
        ...
        bc.doSignrawtransaction(validHex, txid_vout_scrpubkey_obj, invBills)
          .then((res) => {
    ...
    it("submitblock command", function (done) {
      stdout = capcon.interceptStdout(function capture() {
        bc.doSubmitblock(validHex, addr_r)
          .then((res) => {
    ...
    it("verifymessage command", function (done) {
      stdout = capcon.interceptStdout(function capture() {
        bc.doVerifymessage(validHex, validHex, plainTxt)
          .then((res) => {
        ...
        bc.doVerifymessage(invHex, validHex, plainTxt)
          .then((res) => {
            done(new Error("Expected valid hex as the first param"));
          })
          .catch((err) => {
        ...
        bc.doVerifymessage(validHex, invHex, plainTxt)
          .then((res) => {
            done(new Error("Expected valid hex as the second param"));
          })
          .catch((err) => {
        ...
        bc.doVerifymessage(validHex, invHex, destination)
          .then((res) => {
