...
const ZigbeeGateway = require('modules/iot/device/zigbee/gateway');
const ZigbeeDevice = require('modules/iot/device/zigbee/device');
const TrackingEvent = require('modules/iot/device/tracking_event');
    ...
    initapp(callback) {
        try {
            ...
            for (let i = 0; i < protocols.length; i++) {
                ...
                let ProtocolHandler = require("modules/iot/protocols/" + protocols[i].name);
